/* Bubble Sort
    Algorithm: Two Consecutive elements are compared until the end of the list is reached.
    ...
    Intermediate Result is useful: Element at the end is the largest

    Time Complexity:
    bubbleSort() = O(n^2)
    bubbleSortAdaptive() = O(n)
*/
#include<stdio.h>
